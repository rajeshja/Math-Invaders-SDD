...
##
## Score tracking lives here (via HUD) rather than in a GameManager
## autoload for now - GameManager gains real responsibility starting
## Phase 4 (health/lives/game-over), per the Build Plan's phase scoping.
class_name Main
extends Node2D
