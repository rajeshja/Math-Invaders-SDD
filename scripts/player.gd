...
## are untouched (FR19.4). A null texture is ignored defensively so a bad
## configuration can never blank the ship (Phase 21 FR21.4).
func apply_ship_texture(texture: Texture2D) -> void:
