# Math Invaders Educational Game

## About

This is a Godot project for an educational game. 

The specs, tech stack details, plan and phase details are captured in these folders
- `specs/`
- `specs/phases` 

### Available Documents

[Game specifications](./specs/Math_Invaders_Spec.md)
[Game Tech Stack details](./specs/Math_Invaders_Tech_Stack.md)
[Game Development Plan](./specs/Math_Invaders_Build_Plan.md)

### Phase-wise details

- [Phase 0: Project Setup](./specs/phases/Phase_0_Project_Setup.md) - Complete
- [Phase 1: Minimum Playable Loop](./specs/phases/Phase_1_Minimum_Playable_Loop.md) - Complete
- [Phase 2: Question Strategy And Bullets](./specs/phases/Phase_2_Question_Strategy_And_Bullets.md) - Complete
...
- c:\software\Godot 4.7.2\Godot_v4.7.2-stable_win64_console.exe 
- c:\software\Godot 4.7.2\Godot_v4.7.2-stable_win64.exe